...
document.addEventListener('DOMContentLoaded', () => {
    ...
    donationForm.addEventListener('submit', (event) => {
        ...
        // Validate the collected form data before proceeding
        ...
        alert("Donation recorded successfully!"); // Alert the user
    });
...
// Export function for testing purposes (e.g., in unit tests)
